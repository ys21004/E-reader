              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween, // This will space out the children across the row's main axis.
                      children: [
                        Text('Total:', style: TextStyle(fontSize: 17),), // Text at the beginning of the row
                        Text('\$${widget.bookPrice.toStringAsFixed(2)}', style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold)), // Text at the end of the row showing the price with 2 decimal places
                      ],
                    ),
                  ),
